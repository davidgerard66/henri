  ...
  // $("#homeentete").attr('href','http:////www.faire-part-creatif.com');
	...
	pages.click(function(){
	  ...
	  i = parseInt(i);
		...
		//Load content
		var pageNum = this.id;
		var targetUrl = "_ajax_catalogue_content_mpod.asp?page=" + pageNum + "&" + $("#myForm").serialize() + " #content";
	...
	var targetUrl = "_ajax_catalogue_content_mpod.asp?page=1&" + $("#myForm").serialize() + " #content";
	targetUrl = targetUrl.replace("%C3%A9","é");
	targetUrl = targetUrl.replace("%C3%A9","é");
	targetUrl = targetUrl.replace("%C3%A8","è");
	targetUrl = targetUrl.replace("%C3%A8","è");
