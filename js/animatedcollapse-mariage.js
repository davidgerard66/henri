...
function initialiseonglet() {
	
	document.getElementById('perso-photos').className='perso-onglet-mariage'
	document.getElementById('perso-bebe').className='perso-onglet-mariage'
	document.getElementById('perso-autre').className='perso-onglet-mariage'
	document.getElementById('perso-parents').className='perso-onglet-mariage'
...
show:function(divids){ //public method
     ...
     initialiseonglet()  // ajout david
	if (typeof divids=="object"){
		for (var i=0; i<divids.length; i++)
			this.showhide(divids[i], "show")
			document.getElementById('perso-'+divids[i]).className='perso-onglet-select-mariage'  //ajout david
	}
	else
		this.showhide(divids, "show")
		
		document.getElementById('perso-'+divids).className='perso-onglet-select-mariage' //ajout david
},
...
init:function(){
	...
	jQuery(document).ready(function($){
				...
				// ajout dav  --> 
	//attention feinte de sioux  : on remplace le persist cookie par le div que l'on a calculé 'ouvert' dans _bloc_texte.asp
		
	
		var persistopenids = document.getElementById('ongletactif').value;
		document.getElementById('perso-'+persistopenids).className='perso-onglet-select-mariage'	
	
	
	//alert(ongletaactive);
	//ac..showhide(ongletaactive, "show");
