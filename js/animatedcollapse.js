...
function initialiseonglet() {
	...
	document.getElementById('perso-photos').className='perso-onglet'
	document.getElementById('perso-bebe').className='perso-onglet'
	document.getElementById('perso-autre').className='perso-onglet'
	document.getElementById('perso-parents').className='perso-onglet'
...
show:function(divids){ //public method
	...
	if (typeof divids=="object"){
		for (var i=0; i<divids.length; i++)
			...
			document.getElementById('perso-'+divids[i]).className='perso-onglet-select'  //ajout david
	}
	else
		this.showhide(divids, "show")
		
		document.getElementById('perso-'+divids).className='perso-onglet-select' //ajout david
},
...
init:function(){
	...
	//attention feinte de sioux  : on remplace le persist cookie par le div que l'on a calculé 'ouvert' dans _bloc_texte.asp
		...
		document.getElementById('perso-'+persistopenids).className='perso-onglet-select'	
