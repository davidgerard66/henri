...
<table width="798" cellspacing="1">
  <tr>
    <td width="214" >Nombre : </td><td width="380"><input name='nom' type='text' size='40'></td>
    ...
    Area Business Consultancy Services<br />
     ...
     17600 FIGUERES <br />
     GIRONA (Spain) <br />
    Mobil +34 608 99 11 12
    <br />
     Tel&eacute;fono. +34 972 50 20 92<br />
    <a href="mailto:contact@abcs-spain.com">contact@abcs-spain.com</a> </div>
    </td>
  </tr>
<tr>
  <td >Apellidos : </td><td><input name='prenom' type='text' size='40'></td>
  </tr>
...
<tr><td valign="middle" style="font-size:12px">Motivo de su mensaje</td><td valign="middle" >
...
<tr>
  <td>Su mensaje</td><td><textarea name='message' cols='36' rows='8' id="message"></textarea></td>
  </tr>
<tr><td>&nbsp;</td><td>
  <input name='soumettre' type='button' value='Enviar' onclick="javascript:valider()"></td>
  </tr>
</table>
</form>
